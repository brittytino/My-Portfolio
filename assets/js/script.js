...
// Selecting testimonials elements
...
// Function to handle testimonials modal
const testimonialsModalFunc = function () {
  modalContainer.classList.toggle("active");
  overlay.classList.toggle("active");
}

// Event listener for testimonials items
...
// Event listeners for modal close button and overlay
modalCloseBtn.addEventListener("click", testimonialsModalFunc);
overlay.addEventListener("click", testimonialsModalFunc);

// Selecting select elements
...
// Tracking last clicked button for filter
...
// Disable Ctrl+Shift+I, Ctrl, and F12 keys
